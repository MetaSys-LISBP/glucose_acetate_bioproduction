...
<!-- generated with COPASI 4.42 (Build 284) (http://www.copasi.org) at 2025-04-17T16:12:20Z -->
...
<dcterms:W3CDTF>2020-04-30T11:06:43Z</dcterms:W3CDTF>
    ...
    <Function key="Function_41" name="growth" type="UserDefined" reversible="unspecified">
      <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Function_42">
    ...
    <Function key="Function_43" name="function_sink" type="UserDefined" reversible="unspecified">
      <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Function_43">
    ...
    <Function key="Function_44" name="ack" type="UserDefined" reversible="unspecified">
      <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Function_44">
    ...
    <Function key="Function_45" name="pta" type="UserDefined" reversible="unspecified">
      <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Compartment_0">
    ...
    <ListOfMetabolites>
      <Metabolite key="Metabolite_0" name="Glc" simulationType="fixed" compartment="Compartment_0" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_3">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_4" name="X" simulationType="fixed" compartment="Compartment_0" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_4">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_5" name="Ace_out" simulationType="fixed" compartment="Compartment_0" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_5">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_6" name="product" simulationType="fixed" compartment="Compartment_0" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
...
default value: 10000 (i.e., no pulse)
      ...
      <ModelValue key="ModelValue_33" name="v_bioproduction" simulationType="assignment" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_28">
    <dcterms:created>
  ...
  <rdf:Description rdf:about="#Reaction_0">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_250" name="V" value="5557.64"/>
          <Constant key="Parameter_251" name="KM" value="0.02"/>
          <Constant key="Parameter_252" name="Ki" value="36.6776"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_1">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_253" name="v_ACK_Vmax" value="336940"/>
          <Constant key="Parameter_254" name="ACP" value="1"/>
          <Constant key="Parameter_255" name="ADP" value="0.606"/>
          <Constant key="Parameter_256" name="v_ACK_KmACP" value="0.16"/>
          <Constant key="Parameter_257" name="v_ACK_KmADP" value="0.5"/>
          <Constant key="Parameter_258" name="ACE" value="1"/>
          <Constant key="Parameter_259" name="v_ACK_KmACE" value="7"/>
          <Constant key="Parameter_260" name="ATP" value="2.4"/>
          <Constant key="Parameter_261" name="v_ACK_KmATP" value="0.07"/>
          <Constant key="Parameter_262" name="v_ACK_Keq" value="174"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_2">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_263" name="v_PTA_Vmax" value="9.56552e+06"/>
          <Constant key="Parameter_264" name="ACCOA" value="1"/>
          <Constant key="Parameter_265" name="P" value="10"/>
          <Constant key="Parameter_266" name="ACP" value="1"/>
          <Constant key="Parameter_267" name="COA" value="1.22"/>
          <Constant key="Parameter_268" name="v_PTA_KiACCOA" value="0.2"/>
          <Constant key="Parameter_269" name="v_PTA_KmP" value="2.6"/>
          <Constant key="Parameter_270" name="v_PTA_KiP" value="2.6"/>
          <Constant key="Parameter_271" name="v_PTA_KiACP" value="0.2"/>
          <Constant key="Parameter_272" name="v_PTA_KiCOA" value="0.029"/>
          <Constant key="Parameter_273" name="v_PTA_KmACP" value="0.7"/>
          <Constant key="Parameter_274" name="KEQ" value="0.0281"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_3">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_275" name="V" value="740860"/>
          <Constant key="Parameter_276" name="n" value="1"/>
          <Constant key="Parameter_277" name="Km" value="24.7592"/>
          <Constant key="Parameter_278" name="Ki" value="2.32617"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_4">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_279" name="Y" value="9.98043e-05"/>
          <Constant key="Parameter_280" name="sink" value="7785.43"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_5">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_281" name="Kmp" value="33.1536"/>
          <Constant key="Parameter_282" name="Vf" value="480035"/>
          <Constant key="Parameter_283" name="Vr" value="480035"/>
          <Constant key="Parameter_284" name="Kms" value="33.1536"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_6" name="production" reversible="false" fast="false" addNoise="false">
        <ListOfSubstrates>
          <Substrate metabolite="Metabolite_3" stoichiometry="1"/>
        </ListOfSubstrates>
        <ListOfProducts>
        ...
        <ListOfConstants>
          <Constant key="Parameter_285" name="Km" value="0.005"/>
          <Constant key="Parameter_286" name="V" value="555"/>
        </ListOfConstants>
...
<rdf:Description rdf:about="#ModelParameterSet_1">
        ...
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          ...
          <ModelParameter cn="CN=Root,Model=E. coli model - Glc-Ace metabolism,Vector=Values[v_bioproduction]" value="0.97899726962457345" type="ModelValue" simulationType="assignment"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          ...
          <ModelParameterGroup cn="CN=Root,Model=E. coli model - Glc-Ace metabolism,Vector=Reactions[production]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=E. coli model - Glc-Ace metabolism,Vector=Reactions[production],ParameterGroup=Parameters,Parameter=Km" value="0.0050000000000000001" type="ReactionParameter" simulationType="fixed"/>
